...
import com.mirkowu.library.listener.OnItemDragListener;
import com.mirkowu.library.listener.OnItemSwipeListener;
 ...
 */
public abstract class BaseItemDraggableAdapter<T, VH extends BaseRVHolder> extends BaseRVAdapter<T, VH> {
    ...
    public BaseItemDraggableAdapter(@LayoutRes int mLayoutResId) {
        super(mLayoutResId);
    }

    public BaseItemDraggableAdapter(@LayoutRes int mLayoutResId, List<T> mData) {
        super(mLayoutResId, mData);
    }
    ...
    public void onBindViewHolder(VH holder, int positions) {
        ...
        if (mItemTouchHelper != null && itemDragEnabled && viewType != LOADING_VIEW && viewType != HEADER_VIEW
            ...
            if (mToggleViewId != NO_TOGGLE_VIEW) {
                View toggleView = ((BaseRVHolder) holder).getView(mToggleViewId);
                if (toggleView != null) {
                    toggleView.setTag(R.id.XRVAdapter_viewholder_support, holder);
                    if (mDragOnLongPress) {
                ...
                holder.itemView.setTag(R.id.XRVAdapter_viewholder_support, holder);
            ...
            mOnToggleViewLongClickListener = new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (mItemTouchHelper != null && itemDragEnabled) {
                        mItemTouchHelper.startDrag((RecyclerView.ViewHolder) v.getTag(R.id.XRVAdapter_viewholder_support));
                    }
                    return true;
                }
            };
     ...
     * {@link com.mirkowu.library.callback.ItemDragAndSwipeCallback}
     * to the Recycler when you enable this.
     */
