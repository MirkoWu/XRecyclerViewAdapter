...
public abstract class LoadMoreView {
    ...
    public void convert(BaseRVHolder holder) {
    ...
    private void visibleLoading(BaseRVHolder holder, boolean visible) {
        holder.setVisible(getLoadingViewId(), visible);
    }

    private void visibleLoadFail(BaseRVHolder holder, boolean visible) {
        holder.setVisible(getLoadFailViewId(), visible);
    }

    private void visibleLoadEnd(BaseRVHolder holder, boolean visible) {
