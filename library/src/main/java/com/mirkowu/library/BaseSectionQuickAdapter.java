...
import com.mirkowu.library.bean.SectionBean;
 ...
 */
public abstract class BaseSectionQuickAdapter<T extends SectionBean, K extends BaseRVHolder> extends BaseRVAdapter<T, K> {
    ...
    protected abstract void convertHead(BaseRVHolder helper, T item);
